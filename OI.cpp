...
#include "Commands/LauncherDefault.h"
...
OI::OI() {
	...
	defaultLaunch = new JoystickButton(joystickAlt, 2);
	defaultLaunch->WhenPressed(new LauncherDefault());
	...
	SmartDashboard::PutData("LauncherDefault", new LauncherDefault());
