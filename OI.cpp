...
#include "Commands/TestRelayCommand.h"
...
OI::OI() {
	...
	joyTestRelay = new JoystickButton(joystickMain, 5);
	joyTestRelay->WhileHeld(new TestRelayCommand());
	...
	SmartDashboard::PutData("TestRelayCommand", new TestRelayCommand());
