...
Solenoid* RobotMap::feederSoleniodFeederDown = NULL;
...
void RobotMap::init() {
	...
	feederSoleniodFeederDown = new Solenoid(1, 1);
	lw->AddActuator("FeederSoleniod", "FeederDown", feederSoleniodFeederDown);
