...
Ultrasonic* RobotMap::feederUltrasonic = NULL;
AnalogChannel* RobotMap::feederUltrasonicVolts = NULL;
...
void RobotMap::init() {
	...
	feederUltrasonic = new Ultrasonic(1, 4, 1, 6);
	lw->AddSensor("Feeder", "Ultrasonic", feederUltrasonic);
	
	feederUltrasonicVolts = new AnalogChannel(1, 1);
	lw->AddSensor("Feeder", "UltrasonicVolts", feederUltrasonicVolts);
	...
	launcherPositionEncoder = new Encoder(1, 3, 1, 7, false, Encoder::k4X);
	...
	launcherLauncherPID = new PIDController(1.0, 0.0, 0.0,/* F: 0.0, */ launcherPositionEncoder, launcherSpeedController, 0.02);
	lw->AddActuator("Launcher", "LauncherPID", launcherLauncherPID);
	launcherLauncherPID->SetContinuous(false); launcherLauncherPID->SetAbsoluteTolerance(0.2); 
